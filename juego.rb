#1. El código del desafío está desarrollado en el editor de código Visual Studio Code.
#Atom ya murió definitivamente asi que sí, lo desarrolle en VS code
#3. Se establecen las condiciones en función de las instrucciones del juego.
...
puts "(1) para PIEDRA" #0
puts "(2) para PAPEL" #1
puts "(3) para TIJERA" #2
